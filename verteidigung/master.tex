...
%TODO: aufzählung mit punkten oder sowas in der Art!
...
\begin{frame}
  ...
  \end{tcolorbox}
  \pause %TODO: Nachteil weiter hinten?
...
\begin{frame}
  \only<2-5>{\begin{transparent}{0.4}}
  \only<-5>{\begin{multicols}{3}
  \lstinputlisting[
  ...
  \only<2-5>{\end{transparent}}

  \only<2>{\begin{textblock*}{64mm}(32mm,0.25\textheight)
    \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Einstieg in die Funktion,drop fuzzy shadow]
    \lstinputlisting[
      language={[x86masm]Assembler},
      breaklines=true,
      numbers=left,
      ...
      {jit_listing.asm}
      \tcblower
      \centering{\includegraphics[height=0.35\textheight]{figures/match_in_tree-L1}}
    \end{tcolorbox}
  \end{textblock*}}
  
  \only<3>{\begin{textblock*}{64mm}(32mm,0.25\textheight)
    ...
    \lstinputlisting[
      ...
      {jit_listing.asm}
      \tcblower
      \centering{\includegraphics[height=0.35\textheight]{figures/match_in_tree-L1_6}}
    \end{tcolorbox}
  \end{textblock*}}
  
  \only<4>{\begin{textblock*}{64mm}(32mm,0.25\textheight)
    \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Vergleich mit 8,drop fuzzy shadow]
    \lstinputlisting[
      language={[x86masm]Assembler},
      breaklines=true,
      numbers=left,
      ...
      {jit_listing.asm}
      \tcblower
      \centering{\includegraphics[height=0.35\textheight]{figures/match_in_tree-L1_7}}
    \end{tcolorbox}
  \end{textblock*}}
  
  \only<5>{\begin{textblock*}{64mm}(32mm,0.25\textheight)
    ...
    \lstinputlisting[
      ...
      {jit_listing.asm}
      \tcblower
      \centering{\includegraphics[height=0.35\textheight]{figures/match_in_tree-L1_8}}
    \end{tcolorbox}
  \end{textblock*}}
...
%TODO: anderes Bild, eher so:
% Test mit M und M', dann Vergleich der Ergebnisse
...
%TODO: die 3 Fälle (abw) + Vorgehen eläutern
\begin{frame}
...
\begin{frame}
  ...
  \begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Wichtigste Ergebnisse,drop fuzzy shadow]
    ...
    \end{itemize}
  \end{tcolorbox}
  \pause %TODO: Wortwahl Titel nächste Box
...
%TODO: Nicht in Navileiste auftauchen
%\section*{\scshape Fragen?}
\begin{frame}
