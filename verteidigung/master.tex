...
\begin{frame}
  ...
  \tiny
  \begin{table}
  \begin{tabularx}{\textwidth}{p{0.6cm}XXp{0.7cm}p{0.7cm}p{0.6cm}|X}
...
\begin{frame}
  \frametitle{\insertsubsection}
  $k:$ Anzahl der Headerfelder, $n:$ Anzahl der Regeln,\\$w:$ Registerbreite des Systems in bit.
  \pause
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Lineare Suche,drop fuzzy shadow]
...
\begin{frame}
  ...
  \only<3>{\begin{textblock*}{64mm}(32mm,0.25\textheight)
    \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Knoten A: Vergleich mit 5,drop fuzzy shadow]
    \lstinputlisting[
      language={[x86masm]Assembler},
      breaklines=true,
      numbers=left,
  ...
  \only<5>{\begin{textblock*}{64mm}(32mm,0.25\textheight)
    \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Ergebnis: 2. Bitvector,drop fuzzy shadow]
    \lstinputlisting[
      language={[x86masm]Assembler},
      breaklines=true,
      numbers=left,
  ...
  \lstinputlisting[
      ...
      {jit_listing.asm}
  \end{multicols}}
  %TODO: nur Teile des Codes highliten
\end{frame}
