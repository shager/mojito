...
%TODO: Bitvector or bitvector?   entire document!
...
A packet usually consists of header and payload data. %TODO: evtl transparente schichten + jedes layer hat ne aufgabe
...
is is used for network identification, the rest is freely selectable for each host by the owner of the address block.
