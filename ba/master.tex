...
matching performance at the cost of consumed memory and insertion time. %TODO: memory correct?
...
After that, the edges of the rules' intervals are determined.%TODO: Formulierung! (Edges...)
...
\Function{JIT\_creation}{delimiters[], low\_index, high\_index}
    ...
    \If{hi\_index $==$ low\_index} \Comment{Handle base case of the recursion}
        \State \Call{Insert}{Compare: \textsf{\%rax} $<$ delimiters[low\_index]}
        \State \Call{Insert}{Jump: case2}
        \State \Call{Insert}{Return: low\_index}
        \State \Call{Insert}{Return: low\_index - 1} \Comment{case2}
    ...
    \State \Call{Insert}{Compare: \textsf{\%rax} $<$ delimiters[mid\_index]}
    \State \Call{Insert}{Jump: LEFT}
    \State \Call{Insert}{Compare: delimters[mid\_index + 1] $<$ \textsf{\%rax}}
    \State \Call{Insert}{Jump: RIGHT}
    \State \Call{Insert}{Return: mid\_index}
    \State \Call{Insert}{LEFT: left\_tree}
    \State \Call{Insert}{RIGHT: right\_tree}
    \State \Return{Number of written bytes in \textsc{Insert}}
\EndFunction
\end{algorithmic}
...
Figure TODO shows the significant loss in efficiency when inserting rules into the code generating . %TODO: Grafik
