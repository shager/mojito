...
\Function{JIT\_creation}{delimiters[], *executable\_memory, low\_index, high\_index}
    ...
    \Comment{Handle the base case of the recursion}
    ...
    \State $left\_tree \gets$ \Call{JIT\_creation}{delimiters[], *executable\_memory, low\_index, mid\_index - 1}
    \State $right\_tree \gets$ \Call{JIT\_creation}{delimiters[], *executable\_memory, mid\_index + 1, high\_index}
    
    \State \Call{Insert}{Compare: $x <$ delimiters[mid\_index]}
    \State \Call{Insert}{Jump: LEFT}
    \State \Call{Insert}{Compare: delimters[mid\_index + 1] $< x$}
