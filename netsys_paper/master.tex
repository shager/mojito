...
%\IEEEspecialpapernotice{(KuVS Prize Winner Talk)}
...
instead of searching a linear list, which can lead to a significant performance 
...
%FIXME: diese anmerkung von Sven wurde kaum umgesetzt
