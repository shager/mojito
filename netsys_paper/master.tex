...
matching performance at the cost of consumed memory and rule update time.
This strategy is new as it combines an advanced filtering algorithm with the
performance advantages of instance-specific native code.
...
$R$ for a given $C$ is called the packet classification problem.\footnote{FIXME: reference}
%FIXME: Reference!

%FIXME: diese anmerkung wurde kaum umgesetzt
...
The bitvector algorithm is used in this paper, a more detailed description can be found in Section~\ref{sec:bv-general}.
...
\label{sec:bv-general} %FIXME: hypercube-Bild
...
%FIXME: braucht man evtl trotzdem noch
