...
set nologscale xy
set title '10 seconds of operation, average case'
...
plot 'eval.dat_a'  u 1:2:5 with linespoints t 'Bitvector with JIT' ls 1, '' u 1:3 with linespoints t 'Simple Bitvector' ls 2, ''  u 1:4 with linespoints t 'List' ls 3,\
