...
plot 'eval.dat_a'  u 1:($2/1000) with linespoints t 'Bitvector with JIT' ls 1, '' u 1:($3/1000) with linespoints t 'Simple Bitvector' ls 2, ''  u 1:($4/1000) with linespoints t 'List' ls 3,\
        '' u 1:($2/1000):($5/1000) w yerrorbars notitle ls 4, '' u 1:($3/1000):($6/1000) w yerrorbars notitle ls 5, '' u 1:($4/1000):($7/1000) w yerrorbars notitle ls 6
